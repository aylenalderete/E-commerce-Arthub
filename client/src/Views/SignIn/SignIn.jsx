...
function SignIn() {
    ...
    function handleSubmit(e) {
        ...
        console.log(errors)
        if(!errors.password2 && !errors.email && !errors.password && !errors.name && !errors.birth && !errors.lastname && !errors.type){
                ...
                if (res.data.auth === true) {
                    ...
                    if(res.data.msgUsername){
                        ...
                        setErrormsg({...errormsg,
                            errorUsername:res.data.msgUsername})
                    }
    ...
    else{alert('No se registró la cuenta')}
}
